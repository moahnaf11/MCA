...
const Sidebar: React.FC<SidebarProps> = ({ setopenmenu }) => {
  ...
  return (
    <div
      ref={sidebarRef}
      className="bg-white w-64 absolute md:static top-0 bottom-0 z-50 shadow-lg border-r border-gray-200 flex flex-col"
    >
      {/* Logo */}
